<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="description">
            {{ __('تسمح رموز API للخدمات الخارجية بالمصادقة على التطبيق نيابة عنك.') }}
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="name" type="text" class="mt-1 block w-full text-center" wire:model="createApiTokenForm.name" autofocus />
    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            <div>
                {{ __('يرجى نسخ رمز API الجديد. لأسباب أمان، لن يتم عرضه مرة أخرى.') }}
            </div>

            <x-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                     class="mt-4 bg-gray-100 px-4 py-2 rounded font-mono text-sm text-gray-500 w-full break-all text-center"
    ...
    <x-confirmation-modal wire:model.live="confirmingApiTokenDeletion">
        ...
        <x-slot name="content">
            {{ __('هل أنت متأكد من رغبتك في حذف هذا الرمز؟') }}
        </x-slot>
