    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <div>
                ...
                <x-input id="password" class="block mt-1 w-full text-center" type="password" name="password" required autocomplete="current-password" autofocus />
            </div>
